...
void KVImplRedis::hIncrBy(llvm::StringRef Key, llvm::StringRef Field,
                              int Incr) {
...
bool KVImplRedis::hGet(llvm::StringRef Key, llvm::StringRef Field,
                           std::string &Value) {
...
void KVImplRedis::hSet(llvm::StringRef Key, llvm::StringRef Field,
