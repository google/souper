...
TEST(ParserTest, Errors) {
  struct {
    std::string Test, WantError;
      ...
      { "%0:i4 = var (2345)\n",
        "<input>:1:14: invalid, expected [0|1|x]+ or [n|z|p] or [n|d]+" },
      { "%0:i4 = var (01xa)\n",
        "<input>:1:17: invalid knownbits string" },
      { "%0:i4 = var (xxx)\n",
        "<input>:1:1: knownbits pattern must be of same length as var width" },
      ...
      { "%0:i8 = var (znpp)\n",
        "<input>:1:17: invalid, more knownbits string doesn't expect any repetitions of [n|z|p]" },
      { "%0:i8 = var (nn)\n",
        "<input>:1:1: [n|d]+ not expected in known bits string or more knownbits string for var instruction" },
      { "%0:i8 = var (nd)\n",
        "<input>:1:1: [n|d]+ not expected in known bits string or more knownbits string for var instruction" },
      { "%0:i8 = var (zzp)\n",
        "<input>:1:15: invalid, more knownbits string doesn't expect any repetitions of [n|z|p]" },
      { "%0:i8 = var (nzpdn)\n",
        "<input>:1:17: invalid more knownbits string" },
...
TEST(ParserTest, FullReplacementErrors) {
  struct {
    std::string Test, WantError;
      ...
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 ()\n",
        "<input>:3:11: invalid, expected [0|1|x]+ or [n|z|p] or [n|d]+" },
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 (addd)\n",
        "<input>:3:11: invalid, expected [0|1|x]+ or [n|z|p] or [n|d]+" },
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 (n1dd)\n",
        "<input>:3:12: invalid more knownbits string" },
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 (dddd\n",
      ...
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 (nzp)\n",
        "<input>:3:11: infer instruction expects demanded bits pattern of type [n|d]+" },
      { "%0:i4 = var ; 0\n%1:i4 = mulnuw %0, 1:i4\ninfer %1 (01xx)\n",
        "<input>:3:11: infer instruction expects demanded bits pattern of type [n|d]+" },
